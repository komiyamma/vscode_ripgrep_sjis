...
そこで検知できるようにしたもの。  
- なお、Visual Studio CodeのExtentionとして機能するものは「[vscode_ripgrep_sjis_extension リポジトリ](https://github.com/komiyamma/vscode_ripgrep_sjis_extension/releases) 」にて「rg-sjis-***.vsix」として提供しています。
